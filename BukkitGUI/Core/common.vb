...
Namespace Core
    ...
    Module Common
        ...
        Public Sub Init()
            ...
            livebug.write(loggingLevel.Fine, "Common", "Common module initialized")
        End Sub
        ...
        Public Function CheckVersion(oldversion As String, newversion As String) As SByte
            Try
                livebug.write(loggingLevel.Fine, "Common", "Comparing versions: " & oldversion & " - " & newversion)
                ...
                oldversion = System.Text.RegularExpressions.Regex.Replace(oldversion, "[a-zA-z]*\s*", "")
                ...
                livebug.write(loggingLevel.Fine, "Common", "Normalized versions: " & oldversion & " - " & newversion)

                Dim ov As New Version(oldversion)
                Dim nv As New Version(newversion)
                Dim res As SByte = nv.CompareTo(ov)
                livebug.write(loggingLevel.Fine, "Common", "Result of version compare:" & res.ToString)
                Return res
            Catch ex As Exception
                livebug.write(loggingLevel.Warning, "Common", "Couldn't compare versions!", ex.Message)
                Return 0
            End Try
        End Function
        ...
        Public Function Serialize(array() As String) As String
            Try
                ...
                Return result
            Catch ex As Exception
                livebug.write(loggingLevel.Severe, "Common", "Couldn't serialize(array)", ex.Message)
                Return ""
            End Try
        End Function
        ...
        Public Function Serialize(array() As String, separator As Char) As String
            Try
                ...
                Return result
            Catch ex As Exception
                livebug.write(loggingLevel.Severe, "Common", "Couldn't serialize(array,separator)", ex.Message)
                Return ""
            End Try
        End Function
        ...
        Public Function Serialize(list As List(Of String)) As String
            Try
                ...
                Return result
            Catch ex As Exception
                livebug.write(loggingLevel.Severe, "Common", "Couldn't serialize(list)", ex.Message)
                Return ""
            End Try
        End Function
        ...
        Public Function Serialize(list As List(Of String), separator As Char) As String
            Try
                ...
                Return result
            Catch ex As Exception
                livebug.write(loggingLevel.Severe, "Common", "Couldn't serialize (list,separator)", ex.Message)
                Return ""
            End Try
        End Function
        ...
        Public Function CheckServer(url As String) As Boolean
            ...
            Else
                ...
                livebug.write(loggingLevel.Fine, "Common", "Checked server " & url & " - available:" & res.ToString)
                Return res
            End If
        End Function
        ...
        Public Function GetSpaceInDrive(DriveLetter As String) As UInt64
            Try
                ...
                Return 0
            Catch ex As Exception
                livebug.write(loggingLevel.Warning, "common", "Couldn't get free space on drive", DriveLetter)
                Return 0
            End Try
        End Function
